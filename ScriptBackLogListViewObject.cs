...
[AddComponentMenu("ScriptAction/ScriptBackLog/ScriptBackLogListViewObject")]
public class ScriptBackLogListViewObject : ListViewObject
{
    protected ScriptBackLogListViewItemDraw.DispMode dispMode;
    protected GameObject dragObject;
    protected ScriptBackLogListViewItemDraw itemDraw;
    ...
    {
        base.Awake();
        this.itemDraw = base.dispObject.GetComponent<ScriptBackLogListViewItemDraw>();
    }

    public override GameObject CreateDragObject()
    {
        GameObject obj2 = base.CreateDragObject();
        obj2.GetComponent<ScriptBackLogListViewObject>().Init(InitMode.VALID);
        return obj2;
    }
    ...
    public ScriptBackLogListViewItem GetItem() => 
        (base.linkItem as ScriptBackLogListViewItem);
    ...
    {
        ScriptBackLogListViewItem linkItem = base.linkItem as ScriptBackLogListViewItem;
        ScriptBackLogListViewItemDraw.DispMode dispMode = this.dispMode;
        ...
        switch (initMode)
        {
            case InitMode.INVISIBLE:
                this.dispMode = ScriptBackLogListViewItemDraw.DispMode.INVISIBLE;
                this.state = State.IDLE;
                break;

            case InitMode.INVALID:
                this.dispMode = ScriptBackLogListViewItemDraw.DispMode.INVALID;
                this.state = State.IDLE;
                break;

            case InitMode.VALID:
                this.dispMode = ScriptBackLogListViewItemDraw.DispMode.VALID;
                this.state = State.IDLE;
                break;
    ...
    {
        ScriptBackLogListViewItem linkItem = base.linkItem as ScriptBackLogListViewItem;
        base.SetVisible((linkItem != null) && (this.dispMode != ScriptBackLogListViewItemDraw.DispMode.INVISIBLE));
