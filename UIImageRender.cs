...
public class UIImageRender : UITweenRenderer
{
    [CompilerGenerated]
    ...
    public static readonly int BODY_SIZE_Y = 0x3fe;
    ...
    public static readonly int BOTTOM_Y = -510;
    ...
    {
        string name = !imageName.StartsWith("Image/") ? ("Image/" + imageName) : imageName;
    ...
    public void RecoverSharder()
    {
        ...
        if (filterName != null)
        {
            ...
            if (<>f__switch$map12.TryGetValue(filterName, out num))
            {
                if (num == 0)
                {
    ...
    protected void SetCharacterRender()
    {
        ...
        if (this.textureList[1] != null)
        {
            ...
            if (filterName != null)
            {
                ...
                if (<>f__switch$map10.TryGetValue(filterName, out num))
                {
                    if (num == 0)
                    {
        ...
        else
        {
            ...
            if (filterName != null)
            {
                ...
                if (<>f__switch$map11.TryGetValue(filterName, out num))
                {
                    if (num == 0)
                    {
