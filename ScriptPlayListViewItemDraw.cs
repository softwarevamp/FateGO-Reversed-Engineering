...
[AddComponentMenu("Sample/DebugTest/ScriptPlayListViewItemDraw")]
public class ScriptPlayListViewItemDraw : MonoBehaviour
{
    [SerializeField]
    ...
    public void SetItem(ScriptPlayListViewItem item, DispMode mode)
    {
        if (item == null)
        {
