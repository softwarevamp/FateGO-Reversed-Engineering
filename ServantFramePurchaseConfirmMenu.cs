...
public class ServantFramePurchaseConfirmMenu : BaseDialog
{
    [SerializeField]
        ...
        if (this.state == State.INIT)
        {
            ...
            switch (kind)
            {
                ...
                case Kind.STONE:
                    ...
                    this.infoLabel1.text = LocalizationManager.Get("SERVANT_FRAME_PURCHASE_INFO1");
                    this.infoLabel2.text = LocalizationManager.Get("SERVANT_FRAME_PURCHASE_INFO2");
                    ...
                    this.numberLabel1.text = string.Format(LocalizationManager.Get("SERVANT_FRAME_PURCHASE_NUMBERO1"), this.userGameEntity.svtKeep);
                    this.numberLabel2.text = string.Format(LocalizationManager.Get("SERVANT_FRAME_PURCHASE_NUMBERO2"), this.userGameEntity.svtKeep + BalanceConfig.ServantFrameUseStone);
                ...
                case Kind.NO_INFO:
                    ...
                    this.infoLabel3.text = LocalizationManager.Get("SERVANT_FRAME_PURCHASE_INFO1");
                    ...
                    this.numberLabel3.text = string.Format(LocalizationManager.Get("SERVANT_FRAME_PURCHASE_NUMBERO2"), this.userGameEntity.svtKeep);
            ...
            switch (kind)
            {
                case Kind.FRAME:
                    this.warningLabel.text = string.Empty;
                    this.decideLabel.text = LocalizationManager.Get("SERVANT_FRAME_PURCHASE_DECIDE");
                    this.cancelLabel.text = LocalizationManager.Get("SERVANT_FRAME_PURCHASE_CANCEL");
                    break;

                case Kind.STONE:
                    this.warningLabel.text = LocalizationManager.Get("SERVANT_FRAME_PURCHASE_REQUEST_STONE_MESSAGE");
                    this.decideLabel.text = LocalizationManager.Get("SERVANT_FRAME_PURCHASE_STONE");
                    this.cancelLabel.text = LocalizationManager.Get("SERVANT_FRAME_PURCHASE_CANCEL");
                    this.infoLabel1.gameObject.SetActive(false);
                    this.infoLabel2.gameObject.SetActive(false);
                    this.infoLabel3.gameObject.SetActive(false);
                ...
                case Kind.PURCHASE:
                    this.messageLabel.text = string.Format(LocalizationManager.Get("SERVANT_FRAME_PURCHASE_MESSAGE_END"), BalanceConfig.ServantFrameMax);
                    break;

                case Kind.MAX_FRAME:
                    this.messageLabel.text = string.Format(LocalizationManager.Get("SERVANT_FRAME_PURCHASE_MESSAGE_MAX_FRAME"), BalanceConfig.ServantFrameMax);
                    break;

                case Kind.NO_INFO:
                    this.messageLabel.text = string.Format(LocalizationManager.Get("SERVANT_FRAME_PURCHASE_MESSAGE_INFO_NONE"), BalanceConfig.ServantFrameMax);
                    this.infoLabel3.gameObject.SetActive(false);
                    this.numberLabel3.gameObject.SetActive(false);
                    break;
            }
