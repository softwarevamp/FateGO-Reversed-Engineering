...
[AddComponentMenu("Sample/DebugTest/FigureViewListViewItemDraw")]
public class FigureViewListViewItemDraw : MonoBehaviour
{
    [SerializeField]
    ...
    public void SetItem(FigureViewListViewItem item, DispMode mode)
    {
        if (item == null)
        {
