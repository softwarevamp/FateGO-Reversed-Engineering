...
public class XWeaponTrail : MonoBehaviour
{
    ...
    private void InitMeshObj()
    {
        ...
        renderer.GetComponent<Renderer>().sharedMaterial = new Material(this.MyMaterial);
    ...
    public Vector3 CurHeadPos =>
        ((Vector3) ((this.PointStart.position + this.PointEnd.position) / 2f));
    ...
    public class Element
    {
        ...
        public Vector3 Pos =>
            ((Vector3) ((this.PointStart + this.PointEnd) / 2f));
    }
}
