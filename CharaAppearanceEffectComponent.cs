...
public class CharaAppearanceEffectComponent : ProgramEffectComponent
{
    ...
    public void AppearanceStart(UIStandFigureM figure)
    {
        ...
        float num3 = g + 1.003922f;
        this.addVolume = num3;
        this.figure.SetSharder("Custom/Sprite-ScriptActionFigureErasure");
        this.figure.SetFilterColor(this.erasureColor);
        this.figure.SetGradation(g);
        this.SetTweenVolume(g);
        if (base.isSkip)
        {
    ...
    protected void EndCreateEffect(CommonEffectComponent effect)
    {
        ...
        TweenRenderVolume volume = TweenRenderVolume.Begin(base.gameObject, base.duration, 1f);
    ...
    public override void SetTweenVolume(float v)
    {
        ...
        if (this.childEffect != null)
        {
            ...
            if (num > 0f)
            {
                this.childEffect.transform.localPosition = new Vector3(0f, this.bodySize.y * (num - 1f), 0f);
            }
