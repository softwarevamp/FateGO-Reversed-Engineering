...
[AddComponentMenu("Sample/DebugTest/ScriptConnectListViewItemDraw")]
public class ScriptConnectListViewItemDraw : MonoBehaviour
{
    [SerializeField]
    ...
    public void SetItem(ScriptConnectListViewItem item, DispMode mode)
    {
        if (item == null)
        {
