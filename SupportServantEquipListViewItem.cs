...
public class SupportServantEquipListViewItem : ListViewItem
{
    ...
    public SupportServantEquipListViewItem(int index, UserServantEntity userSvtEntity, long targetSvtEquipId, long oldTargetSvtEquipId, long[] useSvtEquipList) : base(index)
    {
    ...
    ~SupportServantEquipListViewItem()
    {
    }
    ...
    Label_0155:
        ...
        switch (sort.Kind)
        {
            ...
            case ListViewSort.SortKind.AMOUNT:
                ...
                {
                    this.amountSortValue = (sort.GetManager() as SupportServantEquipListViewManager).GetAmountSortValue(this.userSvtEntity.svtId);
                }
