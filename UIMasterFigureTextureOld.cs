...
public class UIMasterFigureTextureOld : UIMasterFigureRenderOld
{
    ...
    public void SetCharacter(UIMasterFigureRenderOld.DispType dispType, int genderType, int equipId, System.Action callbackFunc)
    {
        string[] assetNameList = UIMasterFigureRenderOld.GetAssetNameList(genderType, equipId);
