namespace HutongGames.PlayMaker.Actions
{
    ...
    [Tooltip("Sets Event Data before sending an event. Get the Event Data, along with sender information, using Get Event Info action."), ActionCategory(ActionCategory.StateMachine)]
