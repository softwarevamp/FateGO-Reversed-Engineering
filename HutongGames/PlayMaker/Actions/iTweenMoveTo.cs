namespace HutongGames.PlayMaker.Actions
{
    ...
    public class iTweenMoveTo : iTweenFsmAction
    {
        ...
        [HutongGames.PlayMaker.Tooltip("A list of objects to draw a Catmull-Rom spline through for a curved animation path."), CompoundArray("Path Nodes", "Transform", "Vector")]
