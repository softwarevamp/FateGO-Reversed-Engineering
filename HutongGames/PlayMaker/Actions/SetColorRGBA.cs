namespace HutongGames.PlayMaker.Actions
{
    ...
    [HutongGames.PlayMaker.Tooltip("Sets the RGBA channels of a Color Variable. To leave any channel unchanged, set variable to 'None'."), ActionCategory(ActionCategory.Color)]
