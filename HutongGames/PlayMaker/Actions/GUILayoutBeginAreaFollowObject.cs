        ...
        public override void OnGUI()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    float x = vector3.x + (!this.normalized.Value ? this.offsetLeft.Value : (this.offsetLeft.Value * Screen.width));
                    float y = vector3.y + (!this.normalized.Value ? this.offsetTop.Value : (this.offsetTop.Value * Screen.width));
