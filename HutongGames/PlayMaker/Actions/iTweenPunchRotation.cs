namespace HutongGames.PlayMaker.Actions
{
    ...
    [HutongGames.PlayMaker.Tooltip("Applies a jolt of force to a GameObject's rotation and wobbles it back to its initial rotation. NOTE: Due to the way iTween utilizes the Transform.Rotate method, PunchRotation works best with single axis usage rather than punching with a Vector3."), ActionCategory("iTween")]
    public class iTweenPunchRotation : iTweenFsmAction
    {
        ...
        [HutongGames.PlayMaker.Tooltip("A vector punch range."), RequiredField]
