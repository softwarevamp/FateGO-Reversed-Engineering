namespace HutongGames.PlayMaker.Actions
{
    ...
    public class CapturePoseAsAnimationClip : FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.Tooltip("Store the result in an Object variable of type AnimationClip."), UIHint(UIHint.Variable), RequiredField, ObjectType(typeof(AnimationClip))]
