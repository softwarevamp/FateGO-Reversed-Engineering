namespace HutongGames.PlayMaker.Actions
{
    ...
    [HutongGames.PlayMaker.Tooltip("Sets the Scale of a Game Object. To leave any axis unchanged, set variable to 'None'."), ActionCategory(ActionCategory.Transform)]
