namespace HutongGames.PlayMaker.Actions
{
    ...
    [HutongGames.PlayMaker.Tooltip("Sets the XYZ channels of a Vector3 Variable. To leave any channel unchanged, set variable to 'None'."), ActionCategory(ActionCategory.Vector3)]
