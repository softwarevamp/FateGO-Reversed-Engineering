namespace HutongGames.PlayMaker.Actions
{
    ...
    public class ColorInterpolate : FsmStateAction
    {
        ...
        [UIHint(UIHint.Variable), HutongGames.PlayMaker.Tooltip("Store the interpolated color in a Color variable."), RequiredField]
        public FsmColor storeColor;
        [HutongGames.PlayMaker.Tooltip("Interpolation time."), RequiredField]
        public FsmFloat time;

        public override string ErrorCheck() => 
            ((this.colors.Length >= 2) ? null : "Define at least 2 colors to make a gradient.");
