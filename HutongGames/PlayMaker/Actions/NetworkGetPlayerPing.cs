namespace HutongGames.PlayMaker.Actions
{
    ...
    public class NetworkGetPlayerPing : FsmStateAction
    {
        ...
        [HutongGames.PlayMaker.Tooltip("Get the last average ping time to the given player in milliseconds."), ActionSection("Result"), RequiredField, UIHint(UIHint.Variable)]
        ...
        [UIHint(UIHint.Variable), RequiredField, ActionSection("Setup"), HutongGames.PlayMaker.Tooltip("The Index of the player in the network connections list.")]
