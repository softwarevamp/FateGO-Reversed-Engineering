...
[AddComponentMenu("Sample/DebugTest/ScriptObjectListViewItemDraw")]
public class ScriptObjectListViewItemDraw : MonoBehaviour
{
    [SerializeField]
    ...
    public void SetItem(ScriptObjectListViewItem item, DispMode mode)
    {
        if (item == null)
        {
