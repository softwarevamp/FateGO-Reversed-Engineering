...
public class EventPointItemListViewObject : ListViewObject
{
    protected EventPointItemListViewItemDraw.DispMode dispMode;
    protected GameObject dragObject;
    protected EventPointItemListViewItemDraw itemDraw;
    ...
    {
        base.Awake();
        this.itemDraw = base.dispObject.GetComponent<EventPointItemListViewItemDraw>();
    }

    public override GameObject CreateDragObject()
    {
        GameObject obj2 = base.CreateDragObject();
        obj2.GetComponent<EventPointItemListViewObject>().Init(InitMode.VALID);
        return obj2;
    }
    ...
    {
        base.isBusy = true;
        this.dispMode = EventPointItemListViewItemDraw.DispMode.INVISIBLE;
        this.SetupDisp();
        base.SetVisible(false);
        this.dragObject = this.CreateDragObject();
        EventPointItemListViewObject component = this.dragObject.GetComponent<EventPointItemListViewObject>();
        if (component == null)
        {
            Debug.Log("create error?");
            this.EventMoveEnd();
    ...
    private void EventIntoMove2()
    {
        ...
        this.dispMode = EventPointItemListViewItemDraw.DispMode.VALID;
        this.SetupDisp();
        NGUITools.Destroy(this.dragObject);
        this.dragObject = null;
        this.EventMoveEnd();
    ...
    private void EventIntoStart(float delay)
    {
        ...
        base.SetVisible(false);
        this.dragObject = this.CreateDragObject();
        this.dragObject.GetComponent<EventPointItemListViewObject>().Init(InitMode.VALID);
    ...
    public EventPointItemListViewItem GetItem() => 
        (base.linkItem as EventPointItemListViewItem);
    ...
    {
        EventPointItemListViewItem linkItem = base.linkItem as EventPointItemListViewItem;
        EventPointItemListViewItemDraw.DispMode dispMode = this.dispMode;
        ...
        switch (initMode)
        {
            ...
            case InitMode.INVALID:
                this.dispMode = EventPointItemListViewItemDraw.DispMode.INVALID;
                this.state = State.IDLE;
                break;
            ...
            case InitMode.INPUT:
                this.dispMode = EventPointItemListViewItemDraw.DispMode.INPUT;
    ...
    {
        EventPointItemListViewItem linkItem = base.linkItem as EventPointItemListViewItem;
        base.SetVisible((linkItem != null) && (this.dispMode != EventPointItemListViewItemDraw.DispMode.INVISIBLE));
