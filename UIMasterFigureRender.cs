...
public class UIMasterFigureRender : UITweenRenderer
{
    [CompilerGenerated]
    ...
    public void RecoverSharder()
    {
        ...
        if (filterName != null)
        {
            ...
            if (<>f__switch$map15.TryGetValue(filterName, out num))
            {
                if (num == 0)
                {
    ...
    protected void SetCharacterRender()
    {
        ...
        new Vector2((float) entity.offsetX, (float) (entity.offsetY - TOP_Y));
        ...
        if (this.textureList[1] != null)
        {
            ...
            if (filterName != null)
            {
                ...
                if (<>f__switch$map13.TryGetValue(filterName, out num))
                {
                    if (num == 0)
                    {
        ...
        else
        {
            ...
            if (filterName != null)
            {
                ...
                if (<>f__switch$map14.TryGetValue(filterName, out num))
                {
                    if (num == 0)
                    {
