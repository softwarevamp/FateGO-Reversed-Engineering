...
[AddComponentMenu("Sample/DebugTest/BackViewListViewItemDraw")]
public class BackViewListViewItemDraw : MonoBehaviour
{
    [SerializeField]
    ...
    public void SetItem(BackViewListViewItem item, DispMode mode)
    {
        if (item == null)
        {
