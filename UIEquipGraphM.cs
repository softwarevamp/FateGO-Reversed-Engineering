...
public class UIEquipGraphM : UIEquipGraphRender
{
    ...
    {
        string[] assetNameList = UIEquipGraphRender.GetAssetNameList(imageName);
        if (this.loadNameList != null)
        {
    ...
    protected void SetTexture()
    {
        ...
        base.textureList = new Texture2D[] { data.GetObject<Texture2D>(lastName + "a") };
        this.SetTextureStatus();
    }
