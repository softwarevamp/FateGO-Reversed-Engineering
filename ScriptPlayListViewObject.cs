...
[AddComponentMenu("Sample/DebugTest/ScriptPlayListViewObject")]
public class ScriptPlayListViewObject : ListViewObject
{
    protected ScriptPlayListViewItemDraw.DispMode dispMode;
    protected GameObject dragObject;
    protected ScriptPlayListViewItemDraw itemDraw;
    ...
    {
        base.Awake();
        this.itemDraw = base.dispObject.GetComponent<ScriptPlayListViewItemDraw>();
    }

    public override GameObject CreateDragObject()
    {
        GameObject obj2 = base.CreateDragObject();
        obj2.GetComponent<ScriptPlayListViewObject>().Init(InitMode.VALID);
        return obj2;
    }
    ...
    public ScriptPlayListViewItem GetItem() => 
        (base.linkItem as ScriptPlayListViewItem);
    ...
    {
        ScriptPlayListViewItem linkItem = base.linkItem as ScriptPlayListViewItem;
        ScriptPlayListViewItemDraw.DispMode dispMode = this.dispMode;
        ...
        switch (initMode)
        {
            case InitMode.INVISIBLE:
                this.dispMode = ScriptPlayListViewItemDraw.DispMode.INVISIBLE;
                this.state = State.IDLE;
                break;

            case InitMode.INVALID:
                this.dispMode = ScriptPlayListViewItemDraw.DispMode.INVALID;
                this.state = State.IDLE;
                break;

            case InitMode.VALID:
                this.dispMode = ScriptPlayListViewItemDraw.DispMode.VALID;
                this.state = State.IDLE;
                break;
    ...
    {
        ScriptPlayListViewItem linkItem = base.linkItem as ScriptPlayListViewItem;
        base.SetVisible((linkItem != null) && (this.dispMode != ScriptPlayListViewItemDraw.DispMode.INVISIBLE));
