...
public class UIMasterFigureR : MonoBehaviour
{
    ...
    protected void EndRenderAsset(RenderTexture renderTex)
    {
        ...
        {
            MasterFigureManager.Release(this.renderTexture);
        }
        this.renderTexture = renderTex;
        this.bodyTexture.mainTexture = renderTex;
        this.bodyTexture.transform.localPosition = (Vector3) UIMasterFigureRender.GetCharacterOffsetMyroom(this.svtId, this.imageLimitCount);
    ...
    protected void RequestRenderAsset()
    {
        ...
        else
        {
            ...
            this.renderTexture = null;
            MasterFigureManager.Render(renderTexture, this.svtId, this.imageLimitCount, this.faceType, textureList, new StandFigureRenderWaitStatus.EndHandler(this.EndRenderAsset));
        }
    }
    ...
    {
        this.loadNameList = UIMasterFigureRender.GetAssetNameList(svtId, imageLimitCount);
        this.svtId = svtId;
